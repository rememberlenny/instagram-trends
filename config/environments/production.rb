Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "instagram-trends_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = {
    :host => "instagram-trends.herokuapp.com",
    :protocol => "https"
  }
  config.action_mailer.asset_host = "https://instagram-trends.herokuapp.com"
