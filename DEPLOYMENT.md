# How to deploy instagram-trends
...
sudo service unicorn_instagram_trends <start|stop|restart>
sudo service sidekiq_instagram_trends <start|stop>
```
...
```
/home/deployer/apps/instagram_trends/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_instagram_trends restart
sudo service sidekiq_instagram_trends stop
sudo service sidekiq_instagram_trends start
```
